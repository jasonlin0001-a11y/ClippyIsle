...
struct AboutUsView: View {
    ...
    private var privacyPolicyContent: String {
        if isChineseLanguage {
            ...
            CC Isle 尊重並保護所有使用者的隱私權。本隱私權政策說明我們如何處理您的資訊。
            ...
            CC Isle respects and protects the privacy of all users. This privacy policy explains how we handle your information.
        ...
        ScrollView {
            VStack(spacing: 25) {
                ...
                VStack(alignment: .leading, spacing: 15) {
                    ...
                    Text("CC Isle is a powerful clipboard management application that helps you organize, search, and manage your clipboard history efficiently. With features like iCloud sync, speech recognition, and web management, CC Isle makes managing your clipboard content easier than ever.")
                        .font(.body)
                        .foregroundColor(.secondary)
